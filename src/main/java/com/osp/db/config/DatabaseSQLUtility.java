...
public class DatabaseSQLUtility {
    ...
    static {
        try {
            cpds.setJdbcUrl("jdbc:mysql://192.168.1.85:3306/crmmbf?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Ho_Chi_Minh");
            cpds.setUser("crmmbf_app");
            cpds.setPassword("CrmMbf@2022");
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            log.error("Error connect crmmbf_app: "+ex);
        }
        return connection;
    }
//    public static Connection getConnection() {
